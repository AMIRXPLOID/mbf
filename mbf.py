...
time.sleep(3)
os.system("xdg-open https://www.facebook.com/profile.php?id=100041771241191")
os.system("clear")
...
┌────────────────────────────────────────────────────────────────┐
│  Creator  : @AmirGanteng                                           │
│  Github   : https://github.com/AMIRXPLOID                         │
│  Facebook : amirxploit                                           │
│  Contact  : +6285718094505                                     │
└────────────────────────────────────────────────────────────────┘
""")
def balik():
...
def mbf():
    ...
    if f == "1":
         print("\033[1;94mAMBIL COOKIES DI KIWI BROWSER BANG\033[00m")
